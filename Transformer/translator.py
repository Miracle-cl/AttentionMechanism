...
class Translator(object):
    ...
    def __init__(self, opt):
        ...
        # here : model has no attribute encoder
        model = model.module # class DataParallel (‘DataPrallel’ object) to class Transformer
        # here : model can has attribute encoder
    ...
    def translate_batch(self, src_seq, src_pos):
        ...
        def collect_active_part(beamed_tensor, curr_active_inst_idx, n_prev_active_inst, n_bm):
            ...
            # drop samples which finished translating
        ...
        with torch.no_grad():
            ...
            # [[a, b, c], [d, e, f]] - [[a, b, c], [a, b, c], [a, b, c], [d, e, f], [d, e, f], [d, e, f]]
            src_seq = src_seq.repeat(1, n_bm).view(n_inst * n_bm, len_s) # b x sl - (b*n_bm) x sl
