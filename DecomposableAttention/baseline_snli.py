...
class encoder(nn.Module):
    ...
    def __init__(self, num_embeddings, embedding_size, hidden_size, para_init):
        ...
        self.input_linear = nn.Linear(self.embedding_size, self.hidden_size, bias=False)  # linear transformation
        # self.modules include : class encoder, nn.Embedding, nn.Linear
        # self.modules traverse all modules by DFS (itself, and all children)
